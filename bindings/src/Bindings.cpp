...
#include "Bindings/DERogue/Bindings.hpp"
#include "Bindings/DERogue/Protos.hpp"

#include "LikeMagic/Utility/UserMacros.hpp"

#include "derogue/Types.hpp"
...
DLL_PUBLIC void add_bindings(RuntimeTypeSystem& type_sys)
{
    ...
    auto ns_bindings = Namespace::global(type_sys).subspace("Bindings").subspace("DERogue");
